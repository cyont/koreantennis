...
<body id="main_body">
   ...
   <table id="">
       ...
       <div class="content2">
       <h3 class="contentmaintitle_green">Distribution Charts for Active Members as of <?php echo date("M. j, Y"); ?></h3>
       <p>These are distribution charts for active members.</p>
