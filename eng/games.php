...
<body id="main_body">
   ...
   <table>
       ...
       <li>Choose not to be displayed in the list</li>
       </ul>
...
<?php if ($totalRows_rsGameDetails > 0) { ?>
  ...
  <?php do { $current_row++ ?>
	...
	$query_rsNames = "SELECT Id, first_name_eng, last_name_eng FROM members WHERE Id = '" . $row_rsGameDetails['person1'] . "'";
	$rsNames = mysql_query($query_rsNames, $connTennis) or die(mysql_error());
	$row_rsNames = mysql_fetch_assoc($rsNames);
	?>
    <a href="member_details.php?id=<?php echo $row_rsNames['Id']; ?>"><?php echo $row_rsNames['first_name_eng'] . " " . $row_rsNames['last_name_eng']; ?></a>      </td>
      <td><?php echo $row_rsGameDetails['person1_score']; ?></td>
      <td><?php echo $row_rsGameDetails['person2_score']; ?></td>
      <td align="left">
        <?php
	// Query to get person name 2  
	$query_rsNames2 = "SELECT Id, first_name_eng, last_name_eng FROM members WHERE Id = '" . $row_rsGameDetails['person2'] . "'";
	$rsNames2 = mysql_query($query_rsNames2, $connTennis) or die(mysql_error());
	$row_rsNames2 = mysql_fetch_assoc($rsNames2);
	?>
    <a href="member_details.php?id=<?php echo $row_rsNames2['Id']; ?>"><?php echo $row_rsNames2['first_name_eng'] . " " . $row_rsNames2['last_name_eng']; ?></a>      </td>
