...
class Thumbnail {
    ...
    function showErrorImage() {
        ...
        $errImg = ImageCreate(175,25);
        $bgColor = imagecolorallocate($errImg,238,238,238);
        $fgColor1 = imagecolorallocate($errImg,204,204,204);
        $fgColor2 = imagecolorallocate($errImg,204,204,204);
        imagestring($errImg,3,6,6,'>>',$fgColor2);
