...
<body id="main_body">
   ...
   <table>
	   ...
	   <?php do { ?>
		...
		$query_rsMemberList .= "ORDER BY M.last_name ASC, M.first_name ASC";
...
//		mysql_query($change) or die("The change did not work: $change"); 
		...
		do {
		?>
		<div id="leftmargin_40" class="text_black"><?php echo $row_rsMemberList['first_name']; ?> <?php echo $row_rsMemberList['last_name']; ?></div>
		...
		$query_rsMemberInactive .= "ORDER BY M.first_name ASC, M.last_name ASC";
