...
<?php include "email_membersinfo_canceled.php" ?>
...
<h4>Email List of the Cancelled (Total: <?php echo $members->SelectRecordCount(); ?>)</h4>
...
"<?php echo $members->last_name->ListViewValue() ?> <?php echo $members->first_name->ListViewValue() ?>"
    &lt;<?php echo $members->zemail->ListViewValue() ?>&gt;;
    <br />
