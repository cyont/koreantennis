...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("memberslist.php"); // Exit and go to default page  // After login, go to this page.
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("announcementlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("commentslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("courtslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("memberslist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("picslist.php");
		if ($Security->IsLoggedIn()) {
