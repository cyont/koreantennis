...
define("EW_ROOT_RELATIVE_PATH", "C:\inetpub\wwwroot\project1", TRUE); // Relative path of app root
...
define("EW_RANDOM_KEY", 'coWbhuXTX3wH5e01', TRUE); // Random key for encryption
...
define("EW_CONN_USER", 'koreante_dbo3610', TRUE);
define("EW_CONN_PASS", 'wasuri889', TRUE);
define("EW_CONN_DB", 'koreante_db3610', TRUE);

//define("EW_CONN_HOST", "db2855.perfora.net", TRUE);   
//define("EW_CONN_PORT", 3306, TRUE);
//define("EW_CONN_USER", "dbo361004340", TRUE);
//define("EW_CONN_PASS", "wasuriri", TRUE);
//define("EW_CONN_DB", "db361004340", TRUE);
