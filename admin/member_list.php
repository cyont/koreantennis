...
<?php include "member_list_info.php" ?>
...
<h4>Member List  (Total: <?php echo $members->SelectRecordCount(); ?>) => <a href="member_list_print.php" target="_blank">Print</a> </h4> 
...
?>
  ...
  <tr>
    <td><?php echo $members->last_name->ListViewValue() ?>, <?php echo $members->first_name->ListViewValue() ?>&nbsp;</td>
    <td><?php echo $members->first_name_eng->ListViewValue() ?> <?php echo $members->last_name_eng->ListViewValue() ?>&nbsp;</td>
    <td><?php echo $members->phone_cell->ListViewValue() ?>&nbsp;</td>
    <td><?php echo $members->phone_home->ListViewValue() ?>&nbsp;</td>
    <td><?php echo $members->zemail->ListViewValue() ?>&nbsp;</td>
    <!--
    <td><?php echo $members->address->ListViewValue() ?>&nbsp;</td>
    <td><?php echo $members->city->ListViewValue() ?>&nbsp;</td>
    <td><?php echo $members->zip->ListViewValue() ?>&nbsp;</td>
    -->
  </tr>
